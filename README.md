...
- ⭐ Analyze restaurant rating distribution and quality standards
- 💰 Understand the relationship between cost and customer satisfaction
...
│
├── notebooks/
│   └── zomato_analysis.ipynb        # Jupyter notebook with complete analysis
│
├── visuals/
│   ├── cost_rating_correlation.png
...
3. **Pricing Dynamics**
   - Average cost ₹418 shows affordable dining options
   - Mid-range restaurants (₹300-700) receive highest engagement
...
3. **Optimize Pricing Strategy**
   - Consider mid-range pricing (₹400-600)
